...
class SampleRateConverter:
    ...
    @staticmethod
    def convert_all_to_defined_sample_rate(environment: Environment, target_sample_rate: int) -> None:
        """
    ...
    @staticmethod
    def convert_all_to_sample_rate_of_audio_file(environment: Environment, audio_file: Audio) -> None:
        """
        ...
        SampleRateConverter.convert_all_to_defined_sample_rate(environment, target_sample_rate)
