...
spectrogram_plot(combined_audio)
...
window_size = 2048
hop_length = 512
stft_matrix = stft(combined_audio.get_audio_signal(), window_size, hop_length)
...
def notch_filter(audio: Audio, freq) -> Audio:
    ...
    filtered_signal = filtfilt(b, a, audio.get_audio_signal())
